...
git add data/curated.json data/spain.json data/polls.json data/markets.json data/feedback.json data/scores_cache.json data/seen_intl.json data/feedback_processed.json 2>/dev/null
