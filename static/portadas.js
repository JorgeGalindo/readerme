(function () {
  ...
  button.addEventListener('click', async () => {
    ...
    try {
      ...
      if (!Array.isArray(data.headlines) || !Number.isFinite(date.getTime())) throw new Error('Respuesta incompleta');
      ...
      time.textContent = 'Consultado a las ' + date.toLocaleTimeString('es-ES');
    } catch {
